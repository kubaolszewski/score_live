...
class HomeScreenRepository {
  ...
  Future<List<MatchModel>?> fetchLiveMatches() async {
    return (await liveMatchesRemoteService.fetchLiveMatches(live: 'all'))
        .response;
    // final response = [
    //   {
    //     "fixture": {
  ...
  Future<List<MatchModel>?> fetchMatchesByDate(
    ...
    return (await liveMatchesRemoteService.fetchMatchesByDate(
            status: AppConstVariables.fullTime, date: date))
        .response;
    // final response = [
    //   {
    //     "fixture": {
  ...
  Future<List<MatchModel>?> fetchUpcomingMatches(
      String status, String date) async {
    return (await liveMatchesRemoteService.fetchMatchesByDate(
            status: AppConstVariables.matchNotStarted, date: date))
        .response;
    //   final response = [
    //     {
    //       "fixture": {
