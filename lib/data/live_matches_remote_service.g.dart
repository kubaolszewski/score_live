...
class _LiveMatchesRemoteService implements LiveMatchesRemoteService {
  ...
  @override
  Future<MatchLineUps> fetchMatchLineUps({required String matchID}) async {
    const _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{r'fixture': matchID};
    final _headers = <String, dynamic>{};
    final Map<String, dynamic>? _data = null;
    final _result = await _dio
        .fetch<Map<String, dynamic>>(_setStreamType<MatchLineUps>(Options(
      method: 'GET',
      headers: _headers,
      extra: _extra,
    )
    ...
    final value = MatchLineUps.fromJson(_result.data!);
    return value;
  }
